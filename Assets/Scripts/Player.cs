...
public class Player : MonoBehaviour,IKitchenObjectParent {
    ...
    public event EventHandler<OnSelectedCounterChangedEventArgers> OnSelectedCounterChanged;
    public class OnSelectedCounterChangedEventArgers : EventArgs {
    ...
    private void SetSelectedCounter(BaseCounter selectedCounter) {
        ...
        OnSelectedCounterChanged?.Invoke(this, new OnSelectedCounterChangedEventArgers {
